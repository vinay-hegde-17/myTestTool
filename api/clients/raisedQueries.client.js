...
class RaisedQueriesClient {
    ...
    getRaisedQueries(filter = false) {
        return this.request.get(
            RAISED_QUERIES_ENDPOINTS.GET_ALL,
            {
                params: {
                    filter
                },
    ...
    getQueryTypes() {
        return this.request.get(
            RAISED_QUERIES_ENDPOINTS.GET_TYPES,
            {
                headers: this.authHeaders()
            }
        );
    ...
    createRaisedQuery(payload) {
        return this.request.post(
            RAISED_QUERIES_ENDPOINTS.CREATE_QUERY,
            {
                headers: {
                    ...this.authHeaders(),
    ...
    updateRaisedQueryReply(payload) {
        return this.request.put(
            RAISED_QUERIES_ENDPOINTS.UPDATE_QUERY,
            {
                headers: {
                    ...this.authHeaders(),
                    'Content-Type': 'application/json'
    ...
    updateRaisedQuery(payload) {
        return this.request.put(
            RAISED_QUERIES_ENDPOINTS.UPDATE_RAISE_QUERY,
            {
                headers: {
                    ...this.authHeaders(),
                    'Content-Type': 'application/json'
    ...
    getFAQQueries() {
        return this.request.get(
            RAISED_QUERIES_ENDPOINTS.GET_FAQ,
            {
                headers: this.authHeaders()
            }
        );
