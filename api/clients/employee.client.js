...
class EmployeeClient {
  ...
  listEmployees(params = {}) {
    return this.request.get(EMPLOYEE_ENDPOINTS.LIST, {
  ...
  getProfileDetails(employeeId) {
    return this.request.get(EMPLOYEE_ENDPOINTS.PROFILE_DETAILS, {
      headers: this.authHeaders(),
      params: {
        _id: employeeId,
      },
  ...
  getEmployeeForEdit(employeeId) {
    return this.request.get(`${EMPLOYEE_ENDPOINTS.TO_EDIT}/${employeeId}`, {
      headers: this.authHeaders(),
    });
  }

  getEmployeeByEmail(emailId) {
    return this.request.get(EMPLOYEE_ENDPOINTS.EMAIL_ID, {
      headers: this.authHeaders(),
      params: {
        emailId,
      },
  ...
  getEmployeesByRole(params = {}) {
    return this.request.get(EMPLOYEE_ENDPOINTS.BY_ROLE, {
      headers: this.authHeaders(),
      params,
    });
  }
  ...
  checkEmail(emailId) {
    return this.request.get(EMPLOYEE_ENDPOINTS.CHECK_EMAIL, {
      headers: this.authHeaders(),
      params: {
        emailId,
      },
  ...
  getNewJoinees() {
    return this.request.get(EMPLOYEE_ENDPOINTS.GET_NEW_JOINEES, {
      headers: this.authHeaders(),
    });
  }

  getLongServiceEmployees() {
    return this.request.get(EMPLOYEE_ENDPOINTS.GET_LONG_SERVICE_EMP, {
      headers: this.authHeaders(),
    });
  }
  ...
  fetchFile(fileId) {
    return this.request.get(`${EMPLOYEE_ENDPOINTS.FETCH_FILE}/${fileId}`, {
      headers: this.authHeaders(),
    });
  }

  createEmployee(payload) {
    return this.request.post(EMPLOYEE_ENDPOINTS.CREATE, {
      headers: {
        ...this.authHeaders(),
  ...
  updateEmployee(employeeId, payload) {
    return this.request.put(`${EMPLOYEE_ENDPOINTS.UPDATE}/${employeeId}`, {
      headers: this.authHeaders(),
      data: payload,
    });
  }
  ...
  updateAssignedIds(payload) {
    return this.request.put(EMPLOYEE_ENDPOINTS.UPDATE_ASSIGNED_IDS, {
      headers: {
        ...this.authHeaders(),
        "Content-Type": "application/json",
      },
  ...
  getEmployeeDetails(employeeId) {
    return this.request.get(`${EMPLOYEE_ENDPOINTS.LIST}/${employeeId}`, {
      headers: this.authHeaders(),
    });
  }
