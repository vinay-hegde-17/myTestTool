...
class HolidayClient {
    ...
    async getHolidays() {
        return await this.request.get(
            HOLIDAY_ENDPOINTS.GET_HOLIDAYS,
    ...
    async getHolidayYears() {
        return await this.request.get(
            HOLIDAY_ENDPOINTS.GET_HOLIDAY_YEARS,
            { headers: { Authorization: `Bearer ${this.token}` } }
        );
    }
    ...
    async createHoliday(payload) {
        return await this.request.post(
            HOLIDAY_ENDPOINTS.CREATE_HOLIDAY,
            {
                headers: { Authorization: `Bearer ${this.token}` },
                data: payload
            }
    ...
    async importHolidays(payload) {
        return await this.request.post(
            HOLIDAY_ENDPOINTS.IMPORT_HOLIDAYS,
            {
                headers: { Authorization: `Bearer ${this.token}` },
                data: payload
            }
    ...
    async importExcel(payload) {
        return await this.request.post(
            HOLIDAY_ENDPOINTS.IMPORT_HOLIDAYS_EXCEL,
            {
                headers: { Authorization: `Bearer ${this.token}` },
                data: payload
            }
    ...
    async resetAllHolidays() {
        return await this.request.delete(
            HOLIDAY_ENDPOINTS.RESET_HOLIDAYS,
            { headers: { Authorization: `Bearer ${this.token}` } }
        );
    }
